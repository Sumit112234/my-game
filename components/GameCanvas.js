...
export default function GameCanvas({ players, food, myPlayerId, particles }) {
  ...
  const draw = useCallback(() => {
    ...
    if (food) {
      ...
      ctx.fillStyle = grd
      ctx.beginPath(); ctx.arc(fx, fy, radius * 2.5, 0, Math.PI * 2); ctx.fill()
      ...
      ctx.beginPath(); ctx.arc(fx - radius * 0.25, fy - radius * 0.25, radius * 0.3, 0, Math.PI * 2); ctx.fill()
    }
  ...
  return (
    <div className="relative canvas-glow rounded-xl overflow-hidden">
      ...
      />
      <div className="absolute top-0 left-0 w-6 h-6 border-t-2 border-l-2 border-neon-green/60 rounded-tl-xl pointer-events-none" />
      <div className="absolute top-0 right-0 w-6 h-6 border-t-2 border-r-2 border-neon-green/60 rounded-tr-xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-6 h-6 border-b-2 border-l-2 border-neon-green/60 rounded-bl-xl pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-6 h-6 border-b-2 border-r-2 border-neon-green/60 rounded-br-xl pointer-events-none" />
    </div>
  )
}
